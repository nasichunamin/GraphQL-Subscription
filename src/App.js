...
mutation updateData($id: Int!, $is_done: Boolean ) {
...
function TodoList() {
  ...
  const [insertTodos, {loading: loadingInsert}] = useMutation(insertTodo, {refetchQueries: [getTodoList]})
  const [updateTodos, {loading: loadingUpdate}] = useMutation(updateTodo, {refetchQueries: [getTodoList]})
  const [deleteTodos, {loading: loadingDelete}] = useMutation(deleteTodo, {refetchQueries: [getTodoList]})
